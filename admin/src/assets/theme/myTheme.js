const myTheme = {
  ...
  alert: {
    ...
    withClose: "pr-12",
    success: "bg-pink-50 text-pink-900 dark:bg-pink-600 dark:text-white",
    ...
    icon: {
      base: "h-5 w-5",
      success: "text-pink-400 dark:text-pink-300",
  ...
  badge: {
    ...
    success: "text-pink-600 bg-pink-100 dark:bg-pink-800 dark:text-pink-100",
  ...
  textarea: {
    ...
    valid:
      "border-pink-600 dark:bg-gray-700 focus:border-pink-400 dark:focus:border-pink-400",
    invalid:
  ...
  input: {
    ...
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400",
    radio: "text-pink-600 form-radio focus:border-pink-400 focus:outline-none",
    checkbox:
      "text-pink-600 form-checkbox focus:border-pink-500 focus:outline-none rounded",
  },
  // HelperText
  helperText: {
    base: "text-xs",
    valid: "text-pink-600 dark:text-pink-400",
  ...
  button: {
    ...
    primary: {
      base: "text-white bg-pink-500 border border-transparent",
      active: "active:bg-pink-600 hover:bg-pink-600",
      disabled: "opacity-50 cursor-not-allowed",
    },
    modern: {
