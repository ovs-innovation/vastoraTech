...
const mobile_service_data: mobile_service_data_type = [
    {
        ...
        sm_info: <>Custom iOS, Android & Cross-Platform Apps – Fast & Scalable with React Native</>,
    },
    {
        id: 2,
        img: app_service_2,
        title: "Cross-platform Apps",
        sm_info: <>Single codebase for Android & iOS — faster launch, lower cost.</>,
    },
    {
        id: 3,
        img: app_service_3,
        title: "Mobile Backend & APIs",
        sm_info: <>Robust backend systems, Firebase, cloud services, and third-party API integration.</>,
    },
    {
        id: 4,
        img: app_service_4,
        title: "App Maintenance",
        sm_info: <>Regular updates, new features, and bug fixes to keep your app running smoothly</>,
    },
]
