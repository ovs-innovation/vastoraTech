...
const quality_data: quality_data_type[] = [
    {
        ...
        title: <>What is Covered in the <br /> Social Media Marketing</>,
    ...
    },
    {
        ...
        title: <>How is Covered in the <br /> Social Media Marketing</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
            "Audience Analysis",
            "Content Strategy",
    ...
    },
    {
        ...
        title: <>Why need Covered in the <br /> Social Media Marketing</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
            "Brand Awareness",
            "Lead Generation",
    ...
    },
    {
        ...
        title: <>Benifits of Social Media Marketing<br /> at present</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
                                    ...
                                    <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <button className="nav-link" id="v-pills-home-tab" data-bs-toggle="pill"
                                            ...
                                            <span>
                                                ...
                                                One-way <br /> Social Media Marketing
                                            </span>
                                        </button>
                                        <button className="nav-link active" id="v-pills-profile-tab" data-bs-toggle="pill"
                                            ...
                                            <span>
                                                ...
                                                Find powerful <br /> Social Media Marketing
                                            </span>
                                        </button>
                                        <button className="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                                            ...
                                            <span>
                                                ...
                                                Resource <br /> Social Media Marketing
                                            </span>
                                        </button>
                                        <button className="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                            ...
                                            <span>
                                                ...
                                                Citation <br /> Social Media Marketing
                                            </span>
                                        </button>
                                    </div>
                                </div>
