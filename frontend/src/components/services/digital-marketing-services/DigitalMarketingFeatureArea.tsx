...
const audit_content: audit_content_type = {
    title: <>Fix your Digital Marketing <br /> Issues in a few minutes</>,
    sm_info: <>Looking for campaign optimization or audience targeting? Check <br /> performance metrics of any digital campaign.</>,
}
const {title, sm_info}  = audit_content
 
const DigitalMarketingFeatureArea = () => {
    return (
        <>
...
export default DigitalMarketingFeatureArea; 