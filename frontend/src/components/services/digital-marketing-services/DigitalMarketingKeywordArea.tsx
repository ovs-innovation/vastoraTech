...
const DigitalMarketingKeywordArea = () => {
    return (
        <>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="keyword-content">
                                <div className="section-title-wrapper mb-60">
                                    <h5 className="section-subtitle mb-20">Target Audience Research</h5>
                                    <h2 className="section-title mb-25">
                                        Strategic Audience <br />
                                        Targeting & Analysis
                                    </h2>
                                    <p className="mb-35">
                                        Our digital marketing approach starts with comprehensive audience research and keyword analysis 
                                ...
                                <div className="keyword-features">
                                    <div className="keyword-feature-item">
                                        ...
                                        <div className="feature-content">
                                            ...
                                            <p>Identify and target specific customer segments for maximum campaign effectiveness</p>
                                        </div>
                                    </div>
                                    <div className="keyword-feature-item">
                                        <div className="feature-icon">
                        ...
                        <div className="col-lg-6">
                            <div className="keyword-img">
                                <Image src={keyword_img} alt="Digital Marketing Keyword Research" />
                            </div>
                        </div>
                    </div>
                </div>
...
export default DigitalMarketingKeywordArea; 