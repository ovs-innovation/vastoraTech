...
const quality_data: quality_data_type[] = [
    {
        ...
        title: <>What is Covered in the <br /> UX/UI Design</>,
    ...
    },
    {
        ...
        title: <>How is Covered in the <br /> UX/UI Design</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
    ...
    },
    {
        ...
        title: <>Why need Covered in the <br /> UX/UI Design</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
    ...
    },
    {
        ...
        title: <>Benifits of UX/UI Design<br /> at present</>,
        info: <>Broken links are links that point to a website <br /> or page that no longer exists.</>,
        features: [
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="optimize-subtitle mb-60">
                                ...
                                <h5 className="section-title-4 fs-54">High-quality <br /> UX/UI Design services</h5>
                            </div>
                        </div>
                    </div>
