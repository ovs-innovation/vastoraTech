...
const audit_content: audit_content_type = {
    title: <>Fix your UX/UI Design <br /> Issues in a few minutes</>,
    sm_info: <>Looking for user experience optimization or interface design? Check <br /> usability metrics of any design project.</>,
}
const {title, sm_info}  = audit_content
 
const UxUiDesignFeatureArea = () => {
    return (
        <>
...
export default UxUiDesignFeatureArea; 